...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/employee/list"
       title="刷新">
        ...
        <c:forEach items="${requestScope.list}" var="dept" varStatus="stat">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="查看" onclick="x_admin_show('查看详情','/employee/getMoreInfo?id=${dept.id}')"
                       href="javascript:;">
